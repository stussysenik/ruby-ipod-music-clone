...
# docker build -t ruby_ipod_music_clone .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name ruby_ipod_music_clone ruby_ipod_music_clone
